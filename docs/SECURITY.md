...
2. Report the vulnerability privately via [GitHub Security Advisory](https://github.com/EveSunMaple/Frosti/security/advisories/new) or email `contact.evesunmaple@outlook.com`.
